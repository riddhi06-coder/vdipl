...
<head>
    @include('components.backend.head')
	   ...
	   <!--end sidebar wrapper-->
                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('manage-clientele.update', $details->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="table-container mb-4" style="margin-bottom: 20px;">
                                            ...
                                            <table class="table table-bordered p-3" id="printsTable" style="border: 2px solid #dee2e6;">
                                                ...
                                                <tbody>
                                                    @php
                                                        $oldEntries = old('banner_items') ?? json_decode($details->banner_items, true) ?? [];
                                                    @endphp
                                                        ...
                                                        <tr>
                                                            <td>
                                                                ...
                                                                @if(isset($entry['image']))
                                                                    <div class="mt-2">
                                                                        <img src="{{ asset('uploads/home/' . $entry['image']) }}" alt="Image" style="max-width: 100px;">
                                        ...
                                        <div class="table-container mb-4" style="margin-bottom: 20px;">
                                            ...
                                            <table class="table table-bordered p-3" id="sectionTable" style="border: 2px solid #dee2e6;">
                                                ...
                                                <tbody>
                                                @php
                                                    $oldEntries = old('items') ?? json_decode($details->items, true) ?? [];
                                                @endphp

                                                @foreach ($oldEntries as $index => $entry)
                                                    <tr>
                                                        <td>
                                                            <input type="file" name="items[{{ $index }}][image]" class="form-control image-input">
                                                            <small class="text-secondary"><b>Note: The file size should be less than 2MB.</b></small>
                                                            <br>
                                                            <small class="text-secondary"><b>Note: Only files in .jpg, .jpeg, .png, .webp format can be uploaded.</b></small>
                                                            ...
                                                            @if(isset($entry['image']))
                                                                <div class="mt-2">
                                                                    <img src="{{ asset('uploads/home/' . $entry['image']) }}" alt="Image" style="max-width: 100px;">
                                                                    <input type="hidden" name="items[{{ $index }}][old_image]" value="{{ $entry['image'] }}">
                                                                </div>
                                                            @endif
                                                        </td>
                                                        <td>
        ...
        <!--Our Clientele both sections Preview & Add More Option-->
        <script>
