                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('home-banner.update', $details->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="col-md-6 mt-3">
                                            ...
                                            <input class="form-control" id="banner_video" type="file" name="banner_video" accept="video/mp4,video/webm,video/ogg">
                                            ...
                                            @if ($details->banner_video)
                                            <div class="mt-2">
                                                <label class="form-label">Current Video:</label>
                                                <video autoplay muted loop controls width="100%" style="border: 1px solid #ccc; border-radius: 5px;">
                                                    <source src="{{ asset('uploads/home/' . $details->banner_video) }}" type="video/mp4">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            @if($details->banner_image)
                                                <div id="bannerImagePreviewContainer" style="margin-top: 10px;">
                                                    ...
                                                    <img id="banner_image_preview" src="{{ asset('uploads/home/' . $details->banner_image) }}" alt="Preview" class="img-fluid" style="max-height: 200px; border: 1px solid #ddd; padding: 5px;">
                                                </div>
                                            @endif
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="banner_image2" type="file" name="banner_image2" accept=".jpg, .jpeg, .png, .webp" onchange="previewImage()">
                                            <div class="invalid-feedback">Please upload an image.</div>
                                            <small class="text-secondary"><b>Note: The file size should be less than 2MB.</b></small>
                                            <br>
                                            <small class="text-secondary"><b>Only .jpg, .jpeg, .png, .webp formats are allowed.</b></small>
                                            ...
                                            @if($details->banner_image2)
                                                <div id="ImagePreviewContainer" style="margin-top: 10px;">
                                                    ...
                                                    <img id="image_preview" src="{{ asset('uploads/home/' . $details->banner_image2) }}" alt="Preview" class="img-fluid" style="max-height: 200px; border: 1px solid #ddd; padding: 5px;">
                                                </div>
                                            @endif
                                        ...
                                        <div class="table-container mb-4" style="margin-bottom: 20px;">
                                            ...
                                            <table class="table table-bordered p-3" id="printsTable" style="border: 2px solid #dee2e6;">
                                                ...
                                                <tbody>
                                                    @php
                                                        // Use old input if available (after validation error), else use existing banner_items
                                                        $bannerItems = old('banner_items', $details->banner_items ?? [['name' => '', 'count' => '']]);
                                                    @endphp

                                                    @foreach ($bannerItems as $index => $entry)
                                                    <tr>
                                                        <td>
