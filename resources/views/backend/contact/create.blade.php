                                ...
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('manage-contact.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input type="email2" class="form-control" id="email2" name="email2" placeholder="Enter Email Address" value="{{ old('email2') }}" >
                                            <div class="invalid-feedback">Please enter a valid Email address.</div>
                                        </div>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input type="text" class="form-control" id="phone" name="phone"
                                                ...
                                                oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 12);" required value="{{ old('phone') }}" >
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea class="form-control" id="address" name="address" placeholder="Enter Address" rows="3" required value="{{ old('address') }}" ></textarea>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control" id="url" name="url" placeholder="Enter Location URL" value="{{ old('url') }}" >
