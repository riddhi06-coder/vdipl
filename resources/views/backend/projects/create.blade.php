                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('projects-details.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="col-md-12" style="margin-bottom: 20px;">
                                            ...
                                            <textarea id="project_name" class="form-control" name="project_name" rows="5" placeholder="Enter Project Name here" required >{{ old('project_name') }}</textarea>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="location" type="text" name="location" placeholder="Enter Project Location" value="{{ old('location') }}" required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="cost" type="text" name="cost" placeholder="Enter Project Cost" value="{{ old('cost') }}" required>
