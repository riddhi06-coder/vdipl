            ...
            <div class="page-title">
              <div class="row">
                ...
                <ol class="breadcrumb">
                    ...
                    <a href="{{ route('manage-career-intro.index') }}">About</a>
                    </li>
                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('manage-career-intro.update', $details->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            @if($details->banner_image)
                                                <div id="bannerImagePreviewContainer" style="margin-top: 10px;">
                                                    <img id="banner_image_preview" src="{{ asset('uploads/career/' . $details->banner_image) }}" alt="Preview" class="img-fluid" style="max-height: 200px; border: 1px solid #ddd; padding: 5px;">
                                                </div>
                                            @endif
                                        </div>
                                        ...
                                        <!-- Image Upload -->
                                        <div class="col-md-6">
                                            <label class="form-label" for="banner_image2">Image<span class="txt-danger">*</span></label>
                                            ...
                                            <div id="ImagePreviewContainer" style="margin-top: 10px;">
                                                <img id="image_preview" src="{{ asset('uploads/career/' . $details->banner_image2) }}" alt="Preview" class="img-fluid" style="max-height: 200px; border: 1px solid #ddd; padding: 5px; background-color: black;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="table-container mb-4" style="margin-bottom: 20px;">
                                            <table class="table table-bordered p-3" id="printsTable" style="border: 2px solid #dee2e6;">
                                                ...
                                                <tbody>
                                                    @php
                                                        $oldEntries = old('banner_items') ?? $bannerItems ?? [['images' => '', 'description' => '']];
                                                    @endphp
                                        ...
                                        <div class="col-md-12" style="margin-bottom: 20px;">
                                            ...
                                            <textarea id="summernote1" class="form-control" name="description1" rows="5" placeholder="Enter Small Description here" required >{{ old('description1', $details->description2) }}</textarea>
                                            <div class="invalid-feedback">Please enter Description here.</div>
                                        </div>
                                        ...
                                        <div class="col-12 text-end">
                                            <a href="{{ route('manage-career-intro.index') }}" class="btn btn-danger px-4">Cancel</a>
