                                ...
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('manage-Job.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="job_type" type="text" name="job_type" placeholder="Enter Job Type" value="{{ old('job_type') }}" required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="job_location" type="text" name="job_location" placeholder="Enter Job Location" value="{{ old('job_location') }}" required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" type="file" id="job_description" name="job_description" accept="application/pdf" required>
                                            
                                            <small class="text-secondary d-block mt-1"><b>Note: The file size should be less than 3MB.</b></small>
                                            <small class="text-secondary d-block"><b>Only .pdf formats are allowed.</b></small>
                                        </div>
