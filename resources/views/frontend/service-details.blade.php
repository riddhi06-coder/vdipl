            ...
            <div class="row d-flex justify-content-around">
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 p-2"> 
                    @if(!empty($intro->image))
                        <img src="{{ asset('uploads/service/' . $intro->image) }}" alt="{{ $service->service }}" class="img-fluid w-100">
                    @endif
                </div>
                ...
                @foreach($bannerTitles as $index => $title)
                    <div class="col-md-3 card-main11">
                        <div class="service-card">
                            <!-- Dynamically display images, titles, and descriptions -->
                            <img src="{{ asset('uploads/service/' . $bannerImages[$index]) }}" alt="{{ $title }}">
                    ...
                    <div class="col-lg-4 col-md-6 mt-5 card-main1">
                        <div class="icon-box">
                            <div class="icon-container">
                                <img src="{{ asset('uploads/service/' . $bannerchooseImages[$index]) }}" alt="Service Banner" style="height:50px; width:50px">
                            </div>
